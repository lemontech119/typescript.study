...
var TodoController = /** @class */ (function (_super) {
    ...
    function TodoController() {
        ...
        _this.client = new client_1.PrismaClient();
        return _this;
    }
    TodoController.prototype.index = function () {
        return this.client.todo.findMany();
    };
    TodoController.prototype.test = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.todo.create({
                            data: {
                                title: 'New Todo Item',
    ...
    ], TodoController.prototype, "test", null);
    __decorate([
